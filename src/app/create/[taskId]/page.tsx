...
function GeneratingView({ progress }: { progress: number }) {
  return (
    <div className="min-h-[85vh] flex flex-col items-center justify-center px-8 text-center">
      {/* Animated icon */}
      <div className="w-20 h-20 rounded-full bg-purple-50 flex items-center justify-center mb-8 animate-float">
      ...
      <p className="text-[13px] text-gray-400 mb-8">Usually takes about 1 minute</p>
      ...
      <div className="w-full max-w-[240px]">
        ...
        <p className="text-[11px] text-gray-300 mt-2">{progress}%</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="px-5 pt-4 pb-10">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-[13px] text-gray-400 mt-1">Save it and share with the world</p>
      </div>
...
function FailedView({ onRetry }: { onRetry: () => void }) {
  return (
    <div className="min-h-[85vh] flex flex-col items-center justify-center px-8 text-center">
      ...
      <h2 className="text-lg font-semibold text-gray-900 mb-1.5">Generation failed</h2>
      <p className="text-[13px] text-gray-400 mb-8 max-w-[260px]">
      ...
      <a href="mailto:support@elser.ai" className="text-[12px] text-purple-500 mt-4 hover:underline">
        Contact support
      </a>
    </div>
  );
...
function TimeoutView() {
  return (
    <div className="min-h-[85vh] flex flex-col items-center justify-center px-8 text-center">
      ...
      <h2 className="text-lg font-semibold text-gray-900 mb-1.5">Taking longer than expected</h2>
      <p className="text-[13px] text-gray-400 max-w-[260px]">
        Your video is still being generated. Please stay on this page.
      </p>
      <a href="mailto:support@elser.ai" className="text-[12px] text-purple-500 mt-6 hover:underline">
        Contact support
      </a>
    </div>
  );
...
function ProgressContent() {
  ...
  if (error || status?.status === 'failed') {
    return <FailedView onRetry={() => router.push('/')} />;
  }
